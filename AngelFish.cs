    ...
    public void DestroyFish()
    {
        ...
        foreach (var i in angelFish)
        {
            if (i.selected)
            {
                ...
                {
                    int temp = PlayerPrefs.GetInt("nAngelFish");
                    temp--;
                    PlayerPrefs.SetInt("nAngelFish", temp);
                ...
                {
                    int temp3 = PlayerPrefs.GetInt("nCAngelFish");
                    temp3--;
                    PlayerPrefs.SetInt("nCAngelFish", temp3);
