    ...
    public void DestroyFish() {
        ...
        foreach (var i in smallFish) {
            if (i.selected) {
                ...
                {
                    int temp = PlayerPrefs.GetInt("nSmallFish");
                    temp--;
                    PlayerPrefs.SetInt("nSmallFish", temp);

                    int temp2 = PlayerPrefs.GetInt("totalFish");
                    temp2--;
                    PlayerPrefs.SetInt("totalFish", temp2);
                }
                else if (SceneManager.GetActiveScene().name.Equals("CoralEnvironment")) {
                    int temp3 = PlayerPrefs.GetInt("nCSmallFish");
                    temp3--;
                    PlayerPrefs.SetInt("nCSmallFish", temp3);
